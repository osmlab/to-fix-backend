const ProjectUserStats = require('../database/db').ProjectUserStats;
 ...
 * @returns {Promise}
 */
module.exports = function(project, was, is) {
  ...
  return ProjectUserStats.findAll({
    ...
    return Promise.all(
      usersAffected.map(function(user) {
        ...
        if (model) {
          ...
          allStats = {};
          allStats[date] = stats;
          return ProjectUserStats.create({
            user: user,
            project_id: project,
            stats: allStats
          });
