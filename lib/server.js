...
server.get('/projects/:project/items/:item/tags', tag.getItemTags);
server.post('/projects/:project/items/:item/tags', tag.createItemTag);
server.delete('/projects/:project/items/:item/tags/:tag', tag.deleteItemTag);
