...
server.get('/projects/:project/items/:item/comments', comment.getItemComments);
server.get(
  '/projects/:project/items/:item/comments/:comment',
  comment.getItemComment
);
server.post(
  '/projects/:project/items/:item/comments',
  comment.createItemComment
);
server.put(
  '/projects/:project/items/:item/comments/:comment',
  comment.updateItemComment
);
server.delete(
  '/projects/:project/items/:item/comments/:comment',
