 ...
 * @typedef Item
 * @type {Object}
 * @property {String} Item.project_id - the id of the project the item belongs to
 * @property {String} Item.id - the id of the item itself
 * @property {Point} [Item.pin] - a validated GeoJSON point representing the queryable location of this item, required on create
 * @property {String} [Item.quadkey] - a quadkey
 * @property {String} [Item.instructions] - the instructions for what needs to be done, required on create
 * @property {String} [Item.createdBy] - the user who created the item
 * @property {FeatureCollection} [Item.featureCollection] - a validated GeoJSON feature collection, required on create
 * @property {String | undefined} Item.status - the status to set the item to
 * @property {String | undefined} Item.lockedTill - the time the lock expires at
 * @property {String} [Item.lockedBy] - user who is asking to lock
 * @property {Object} [Item.metadata] - object key value store for misc info
 */
