...
-   `pin` **[array](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array)** Coordinates array, as [lon, lat]
-   `zoomLevel` **[Number](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number)?** zoomLevel to get quadkey for, defaults to `config.DEFAULT_ZOOM`

Returns **[string](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String)** quadkey string
